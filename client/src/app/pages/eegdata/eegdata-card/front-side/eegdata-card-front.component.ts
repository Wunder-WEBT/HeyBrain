...
@Component({
  selector: 'ngx-eegdata-card-front',
  styleUrls: ['./eegdata-card-front.component.scss'],
  templateUrl: './eegdata-card-front.component.html',
})
export class EEGDataCardFrontComponent implements OnDestroy, OnInit {
  private alive = true;

  @Input() selectedCurrency: string = 'Theta';

  intervalSubscription: Subscription;
  currencies: string[] = ['Theta','Alpha', 'BetaL', 'BetaH', 'Gamma'];
  currentTheme: string;

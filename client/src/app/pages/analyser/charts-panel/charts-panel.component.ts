...
import { DataService, PerformanceMetricDayListItem, PerformanceMetricMonthListItem } from '../../../@core/mock/data.service';
...
export class ECommerceChartsPanelComponent implements OnDestroy {
  ...
  constructor(private ordersProfitChartService: OrdersProfitChartData, private dataService: DataService) {
